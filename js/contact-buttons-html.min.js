...
function _widget_button_start() {
    ...
    if ("true" == _widget_settings.buttons.zalo.visible) var l = '<a aria-label="' + _widget_settings.buttons.zalo.messages + '" class="b24-widget-button-social-item connector-icon connector-icon-zalo" href="https://zalo.me/' + _widget_settings.buttons.zalo.id + '" rel="noopener nofollow" role="button" target="_blank"><span class="b24-widget-button-social-tooltip">' + _widget_settings.buttons.zalo.messages + "</span></a>";
    else "false" == _widget_settings.buttons.zalo.visible ? l = "" : alert("You must set the visible value to true or false");
    ...
    else "false" == _widget_settings.buttons.facebook.visible ? b = "" : alert("You must set the visible value to true or false");
    if ("true" == _widget_settings.buttons.whatsapp.visible) var d = '<a aria-label="' + _widget_settings.buttons.whatsapp.messages + '" class="b24-widget-button-social-item connector-icon connector-icon-whatsapp" href="https://api.whatsapp.com/send?phone=' + _widget_settings.buttons.whatsapp.id + '&text=" rel="noopener nofollow" role="button" target="_blank"><span class="b24-widget-button-social-tooltip">' + _widget_settings.buttons.whatsapp.messages + "</span></a>";
    else "false" == _widget_settings.buttons.whatsapp.visible ? d = "" : alert("You must set the visible value to true or false");
    d = '<div class="b24-widget-button-popup-inner"><div class="b24-widget-button-popup-image"><span class="b24-widget-button-popup-image-item" style="background-image:url(' + _widget_settings.support.staff.image + ');"></span></div><div class="b24-widget-button-popup-content"><div class="b24-widget-button-popup-name">' + _widget_settings.support.staff.name + '</div><div class="b24-widget-button-popup-description">' + _widget_settings.support.staff.messages + "</div></div></div>";
    ...
    if (null != localStorage.getItem("saved_storage") && "true" == localStorage.getItem("saved_storage")) var c = '<div><div class="b24-widget-button-shadow"></div><div class="b24-widget-button-wrapper ' + t + ' b24-widget-button-visible"><div class="b24-widget-button-social b24-widget-button-hide">' + e + i + s + o + n + a + l + b + '</div><div class="b24-widget-button-inner-container"><div class="b24-widget-button-inner-mask"></div><div class="b24-widget-button-block"><div class="b24-widget-button-pulse b24-widget-button-pulse-animate"></div><div class="b24-widget-button-inner-block"><div class="b24-widget-button-icon-container"><div class="b24-widget-button-inner-item b24-widget-button-icon-animation">' + g + '</div><div class="b24-widget-button-inner-item">' + u + '</div><div class="b24-widget-button-inner-item">' + r + '</div></div><div class="b24-widget-button-inner-item b24-widget-button-close">' + w + "</div></div></div></div></div></div>";
    else c = '<div><div class="b24-widget-button-shadow"></div><div class="b24-widget-button-wrapper ' + t + ' b24-widget-button-visible"><div class="b24-widget-button-popup b24-widget-button-popup-show"><span class="b24-widget-button-popup-btn-hide"></span>' + d + '<div class="b24-widget-button-popup-triangle"></div></div><div class="b24-widget-button-social b24-widget-button-hide">' + e + i + s + o + n + a + l + b + '</div><div class="b24-widget-button-inner-container"><div class="b24-widget-button-inner-mask"></div><div class="b24-widget-button-block"><div class="b24-widget-button-pulse b24-widget-button-pulse-animate"></div><div class="b24-widget-button-inner-block"><div class="b24-widget-button-icon-container"><div class="b24-widget-button-inner-item b24-widget-button-icon-animation">' + g + '</div><div class="b24-widget-button-inner-item">' + u + '</div><div class="b24-widget-button-inner-item">' + r + '</div></div><div class="b24-widget-button-inner-item b24-widget-button-close">' + w + "</div></div></div></div></div></div>";
    $(c).appendTo("body"), /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && $("html").addClass("bx-touch crm-widget-button-mobile");
    var v = $(".b24-widget-button-icon-container>.b24-widget-button-inner-item");
    $(v).queue((function t(e) {
        var i = $(this);
        $(v).each((function(t, e) {
            i.queue((function(t) {
                $(e).addClass("b24-widget-button-icon-animation"), t()
            })).delay(1500).queue((function(t) {
                $(e).removeClass("b24-widget-button-icon-animation"), t()
            }))
        })), i.queue(t), e()
    }));
    var p = $(".b24-widget-button-shadow"),
        m = $(".b24-widget-button-wrapper"),
        _ = $(".b24-widget-button-social");
    $(".b24-widget-button-inner-container").click((function(t) {
        t.stopPropagation(), $("html").toggleClass("crm-widget-button-mobile"), $(p).hasClass("b24-widget-button-show") ? $(p).removeClass("b24-widget-button-show").addClass("b24-widget-button-hide") : $(p).hasClass("b24-widget-button-hide") ? $(p).removeClass("b24-widget-button-hide").addClass("b24-widget-button-show") : $(p).addClass("b24-widget-button-show"), $(_).hasClass("b24-widget-button-show") ? $(_).removeClass("b24-widget-button-show").addClass("b24-widget-button-hide") : $(_).hasClass("b24-widget-button-hide") && $(_).removeClass("b24-widget-button-hide").addClass("b24-widget-button-show"), $(m).toggleClass("b24-widget-button-bottom")
    })), $(".b24-widget-button-popup-btn-hide,.b24-widget-button-inner-container").click((function() {
        $(".b24-widget-button-popup").removeClass("b24-widget-button-popup-show").addClass("b24-widget-button-popup-hide"), localStorage.setItem("saved_storage", "true")
    })), $("html").click((function() {
        $(this).removeClass("crm-widget-button-mobile"), $(p).removeClass("b24-widget-button-show b24-widget-button-hide"), $(_).removeClass("b24-widget-button-show").addClass("b24-widget-button-hide"), $(m).removeClass("b24-widget-button-bottom")
    }))
}
