...
function _widget_button_start() {
    ...
    if ("true" == _widget_settings.buttons.whatsapp.visible) var f = '<a aria-label="' + _widget_settings.buttons.whatsapp.messages + '" class="b24-widget-button-social-item connector-icon connector-icon-whatsapp" href="https://api.whatsapp.com/send?phone=' + _widget_settings.buttons.whatsapp.id + '&text=" rel="noopener nofollow" role="button" target="_blank"><span class="b24-widget-button-social-tooltip">' + _widget_settings.buttons.whatsapp.messages + "</span></a>";
    else "false" == _widget_settings.buttons.whatsapp.visible ? f = "" : alert("You must set the visible value to true or false");
var d = '<div class="b24-widget-button-popup-inner"><div class="b24-widget-button-popup-image"><span class="b24-widget-button-popup-image-item" style="background-image:url(' + _widget_settings.support.staff.image + ');"></span></div><div class="b24-widget-button-popup-content"><div class="b24-widget-button-popup-name">' + _widget_settings.support.staff.name + '</div><div class="b24-widget-button-popup-description">' + _widget_settings.support.staff.messages + "</div></div></div>",
    ...
    if (null != localStorage.getItem("saved_storage") && "true" == localStorage.getItem("saved_storage")) var c = '<div><div class="b24-widget-button-shadow"></div><div class="b24-widget-button-wrapper ' + t + ' b24-widget-button-visible"><div class="b24-widget-button-social b24-widget-button-hide">' + e + i + s + o + n + a + l + b + f +'</div><div class="b24-widget-button-inner-container"><div class="b24-widget-button-inner-mask"></div><div class="b24-widget-button-block"><div class="b24-widget-button-pulse b24-widget-button-pulse-animate"></div><div class="b24-widget-button-inner-block"><div class="b24-widget-button-icon-container"><div class="b24-widget-button-inner-item b24-widget-button-icon-animation">' + g + '</div><div class="b24-widget-button-inner-item">' + u + '</div><div class="b24-widget-button-inner-item">' + r + '</div></div><div class="b24-widget-button-inner-item b24-widget-button-close">' + w + "</div></div></div></div></div></div>";
    else c = '<div><div class="b24-widget-button-shadow"></div><div class="b24-widget-button-wrapper ' + t + ' b24-widget-button-visible"><div class="b24-widget-button-popup b24-widget-button-popup-show"><span class="b24-widget-button-popup-btn-hide"></span>' + d + '<div class="b24-widget-button-popup-triangle"></div></div><div class="b24-widget-button-social b24-widget-button-hide">' + e + i + s + o + n + a + l + b + f +'</div><div class="b24-widget-button-inner-container"><div class="b24-widget-button-inner-mask"></div><div class="b24-widget-button-block"><div class="b24-widget-button-pulse b24-widget-button-pulse-animate"></div><div class="b24-widget-button-inner-block"><div class="b24-widget-button-icon-container"><div class="b24-widget-button-inner-item b24-widget-button-icon-animation">' + g + '</div><div class="b24-widget-button-inner-item">' + u + '</div><div class="b24-widget-button-inner-item">' + r + '</div></div><div class="b24-widget-button-inner-item b24-widget-button-close">' + w + "</div></div></div></div></div></div>";
