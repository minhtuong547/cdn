...
function _widget_button_start() {
    ...
    if ("true" == _widget_settings.buttons.whatsapp.visible) var l = '<a aria-label="' + _widget_settings.buttons.whatsapp.messages + '" class="b24-widget-button-social-item connector-icon connector-icon-whatsapp" href="https://api.whatsapp.com/send?phone=' + _widget_settings.buttons.whatsapp.id + '&text=" rel="noopener nofollow" role="button" target="_blank"><span class="b24-widget-button-social-tooltip">' + _widget_settings.buttons.whatsapp.messages + "</span></a>";
    else "false" == _widget_settings.buttons.whatsapp.visible ? l = "" : alert("You must set the visible value to true or false");
